    ...
    return (
      <div className="container">
        ...
        <footer className="text-center">
          <span>Por HuDa Qeshta <i className="far fa fa-copyright"></i> 2024</span>
        </footer>
      </div>
    );
  } 
...
class Operator extends React.Component{
  ...
  render(){
    return(
    <button id={this.props.id} onClick={this.runParentHandleClick} className="btn btn-warning btn-lg">{this.props.value}</button>
    )
  }
}
...
class Button extends React.Component{
  ...
  render(){
    return(
    <button id={this.props.id} onClick={this.runParentHandleClick} className="btn btn-info btn-lg">{this.props.value}</button>
    )
  }
}
...
class Clear extends React.Component{
  ...
  render(){
    return(
    <a id={this.props.id} className="btn btn-secondary btn-lg" onClick={this.runParentHandleClick}>AC</a>
    )
  }
}
...
class Delete extends React.Component{
  ...
  render(){
    return(
    <a id={this.props.id} className="btn btn-secondary btn-lg" onClick={this.runParentHandleClick}>CE</a>
    )
  }
}
...
class Equals extends React.Component{
  ...
  render(){
    return(
  <button id={this.props.id} className="btn btn-secondary btn-lg" onClick={this.runParentHandleClick}>{this.props.value}</button>
  )
  }
}
